...
Это еще не `LDAP/SSO`, но уже рабочий переходный слой к production-модели доступа учреждения.
...
Дополнительные простые пользовательские сценарии:

1. `Служебная записка подразделения: Иван Иванов`
2. `Регламент подразделения: Иван Иванов`
