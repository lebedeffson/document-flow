...
AppVerName=Zope External Editor 0.7.3-ND
AppPublisher=Casey Duncan, Zope Corporation; with modifications by NAUMEN company
...
Source: "PythonCOM22.dll"; DestDir: "{app}"; Flags: ignoreversion
