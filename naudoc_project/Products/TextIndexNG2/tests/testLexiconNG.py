...
from Products.TextIndexNG2.Registry import LexiconRegistry as LR
from Products.TextIndexNG2 import lexicons
...
class StandardLexiconTests(unittest.TestCase):
    ...
    def setUp(self):
        self._lexicon = LR.getRegisteredObject('StandardLexicon')(truncate_left=1)

    def cmp(self, x, y):
        if isinstance(x,ListType) and isinstance(y, ListType):
