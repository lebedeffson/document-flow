...
from Products.TextIndexNG2 import storages
...
class StorageTests(unittest.TestCase):
    ...
    def setUp(self):
        self._storage = SR.getRegisteredObject('StandardStorage')()
    ...
    def testWordFrequency(self):
        ...
        self.assertEqual( (self._storage.getWordFrequency(1,6)), 0)
        self.assertEqual( (self._storage.getWordFrequency(1,22)), 1)
        self.assertEqual( (self._storage.getWordFrequency(1,555555)), 0)
