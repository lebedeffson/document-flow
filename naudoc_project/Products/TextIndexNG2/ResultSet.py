...
$Id: ResultSet.py,v 1.3 2006/03/10 13:29:35 ishabalin Exp $
"""
    ...
    def cosine_ranking(self, index, hits=250):
        ...
        for docid in self.docIds():   # iterate over all found documents
            ...
            for term in self.words().keys():
                ...
                dtf = index.getStorage().getWordFrequency(docid, wid_cache[term])
...
def nearResultSets(sets, index, distance=5, bidirectional=1, do_stem=1):
