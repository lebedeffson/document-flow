...
$Id: Registry.py,v 1.1.1.1 2004/09/20 12:10:01 vpastukhov Exp $
"""

import sys
from types import InstanceType, ClassType,TupleType
...
class Registry:
    ...
    def __init__(self, id, ifaces=None):
        ...
        self.data = {}
        if ifaces: 
            if not isinstance(ifaces, TupleType): ifaces = [ ifaces ]
