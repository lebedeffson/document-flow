...
oRegex.UrlOnChangeTestOther.compile( '^(javascript:|naudoc:|#|/)', 'gi' ) ;
...
var naudoc_window = window.parent.dialogArguments.Editor.parent
...
*/
    naudoc_window.OpenDocumentSelectionWnd('', 'NauSetUrl', '', '', '', '', '', '', 1, window)
}

function NauSetUrl(Null, path, Null, version)
{
    path = naudoc_window.NauPath(path)
