...
function LoadScripts()
{
	...
	{
		AddScript( 'js/internals/fckdebug.js' ) ;
		AddScript( 'js/internals/fcktools.js' ) ;
		AddScript( 'js/internals/fcktools_' + sSuffix + '.js' ) ;
		AddScript( 'js/internals/fckregexlib.js' ) ;
		AddScript( 'js/internals/fcklanguagemanager.js' ) ;
		AddScript( 'js/classes/fckevents.js' ) ;
		AddScript( 'js/internals/fckxhtmlentities.js' ) ;
		AddScript( 'js/internals/fckxhtml.js' ) ;
		AddScript( 'js/internals/fckxhtml_' + sSuffix + '.js' ) ;
		AddScript( 'js/internals/fckcodeformatter.js' ) ;
		AddScript( 'js/internals/fck_1.js' ) ;
		AddScript( 'js/internals/fck_1_' + sSuffix + '.js' ) ;
	}
