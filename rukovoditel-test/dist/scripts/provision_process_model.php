...
sync_field_choices(23, $request_type_id, [
    ['name' => 'Медицинская документация', 'sort_order' => 1, 'is_default' => 1, 'bg_color' => '#bde0fe', 'legacy_names' => ['Методический вопрос']],
...
sync_field_choices(23, $request_service_category_id, [
    ...
    ['name' => 'Медицинские процессы', 'sort_order' => 2, 'legacy_names' => ['Учебный процесс']],
...
sync_field_choices(25, $doc_type_id, [
    ...
    ['name' => 'Медицинский документ', 'sort_order' => 4, 'bg_color' => '#f8edeb'],
