...
{   
    case 'open':                
        ...
        $editor_mode = onlyoffice::getMode($cfg,$current_entity_id,$current_item_id);
        $integration_base_url = onlyoffice::getIntegrationBaseUrl();
        $download_url = onlyoffice::getDownloadUrl($file, true, $integration_base_url);
        $callback_url = onlyoffice::buildAbsoluteUrl(
            url_for('onlyoffice/callback', 'entity_id=' . $current_entity_id . '&item_id=' . $current_item_id . '&field=' . $field_id. '&file=' . $file_id . '&date=' . $file['date_added']),
            $integration_base_url
        );

         // specify the document config
        $config = [
            "type" => onlyoffice::detectEditorType(),
            ...
            "document" => [
             ...
             "editorConfig" => [
                 ...
                 'location' => $cfg->get('location') ?: 'ru',
                 'region' => $cfg->get('region') ?: 'ru-RU',
