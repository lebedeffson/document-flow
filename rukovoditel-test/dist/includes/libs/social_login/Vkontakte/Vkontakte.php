...
if(!class_exists('Vkontakte')){
    class Vkontakte{
         ...
         *
         * @link https://vk.ru/dev/versions API version list
         */
        ...
        */
        ...
        public function getLoginUrl()
        {
            ...
            return 'https://oauth.vk.ru/authorize?' . http_build_query($params);
        }
        ...
        public function authenticate($code = null)
        {
            ...
            $url = 'https://oauth.vk.ru/access_token?' . http_build_query(array(
                    'client_id' => $this->getClientId(),
        ...
        /**
         * Make an API call to https://api.vk.ru/method/
         *
        ...
        public function api($method, array $query = array())
        {
            ...
            $url = 'https://api.vk.ru/method/' . $method . '?' . http_build_query($query);
