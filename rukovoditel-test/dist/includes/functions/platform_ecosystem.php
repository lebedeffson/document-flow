...
if(!function_exists('platform_document_route_specs'))
{
    function platform_document_route_specs()
    {
        return [
            ...
            'Служебная записка / приказ / локальный акт' => [
                'wave_label' => 'Боевой маршрут первой волны',
                'summary' => 'Служебный документ подразделения с согласованием, утверждением и регистрацией при необходимости.',
                'creator_roles' => 'Сотрудник подразделения или координатор',
                'approval_roles' => 'Руководитель подразделения',
                'registration_roles' => 'Канцелярия при обязательной регистрации',
                'draft_system' => 'Rukovoditel + ONLYOFFICE Docs',
                'official_system' => 'NauDoc',
                'status_flow' => 'Черновик -> На согласовании -> На утверждении -> Подписан -> На регистрации -> Зарегистрирован -> Архивирован',
            ],
            'Регламенты и документы подразделения' => [
                'wave_label' => 'Боевой маршрут первой волны',
                'summary' => 'Нормативный или регламентный документ подразделения с рабочим черновиком и официальным статусом в NauDoc.',
                'creator_roles' => 'Сотрудник подразделения или координатор',
                'approval_roles' => 'Руководитель подразделения',
                'registration_roles' => 'Канцелярия при обязательной регистрации',
                'draft_system' => 'Rukovoditel + ONLYOFFICE Docs',
