...
seed_reference_onlyoffice \
  ...
  "department-memo-ivan-ivanov.docx" \
  "Служебная записка подразделения: Иван Иванов" \
  "Контрольный пользовательский сценарий для служебной записки подразделения." \
  "Документ нужен для проверки внутреннего маршрута, редактирования и публикации."

seed_reference_onlyoffice \
  "Регламент подразделения: Иван Иванов" \
  "department-regulation-ivan-ivanov.docx" \
  "Регламент подразделения: Иван Иванов" \
  "Контрольный пользовательский сценарий для регламента подразделения." \
  "Документ нужен для проверки нормативного маршрута и совместной правки."
