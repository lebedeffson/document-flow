...
(15,0,0,0,1774422000,1774785745,3,0,'Служебная записка подразделения: Иван Иванов',419,425,'СЗ-2026-021',1774422000,'1',1798700400,'1.0','https://docflow.hospital.local/docs/storage/bridge_document_cards_15','','','<p>Простой внутренний документ подразделения: служебная записка оформляется в рабочем контуре, редактируется в ONLYOFFICE и получает официальный объект в NauDoc.</p><p>Исполнитель: Иван Иванов.</p>','','3','https://docflow.hospital.local/index.php?module=dashboard/ecosystem&service=docspace&entity_id=25&item_id=15','https://docflow.hospital.local/index.php?module=dashboard/ecosystem&service=workspace&entity_id=25&item_id=15',822,840,841),
(16,0,0,0,1774422000,1774785745,7,0,'Регламент подразделения: Иван Иванов',421,425,'РГ-2026-009',1774422000,'1',1798700400,'1.0','https://docflow.hospital.local/docs/storage/bridge_document_cards_16','','','<p>Простой нормативный документ для теста внутреннего маршрута: подготовка регламента подразделения, совместная правка и публикация в официальный контур.</p><p>Ответственный сотрудник: Иван Иванов.</p>','','4','https://docflow.hospital.local/index.php?module=dashboard/ecosystem&service=docspace&entity_id=25&item_id=16','https://docflow.hospital.local/index.php?module=dashboard/ecosystem&service=workspace&entity_id=25&item_id=16',821,838,841),
...
(6,0,0,0,1774335600,1774785670,3,0,'Простой шаблон документа: Иван Иванов',754,758,'1.0','3',1798700400,'https://docflow.hospital.local/docs','тест,иван иванов,простой шаблон','<p>Обычный рабочий шаблон для быстрой подготовки документа. Можно открыть, скопировать как основу, заполнить данными подразделения или локального регламента и передать в согласование.</p><p>Пример исполнителя: Иван Иванов.</p>','','https://docflow.hospital.local/index.php?module=dashboard/ecosystem&service=docspace&entity_id=26&item_id=6','https://docflow.hospital.local/index.php?module=dashboard/ecosystem&service=workspace&entity_id=26&item_id=6',844,847),
(7,0,0,0,1774422000,1774785670,3,0,'Шаблон служебной записки подразделения',754,758,'1.0','3',1798700400,'https://docflow.hospital.local/docs','служебная записка,подразделение,согласование','<p>Простой шаблон служебной записки подразделения. Используется как основа для теста внутреннего сценария: заполнить, согласовать и передать в официальный контур.</p>','','https://docflow.hospital.local/index.php?module=dashboard/ecosystem&service=docspace&entity_id=26&item_id=7','https://docflow.hospital.local/index.php?module=dashboard/ecosystem&service=workspace&entity_id=26&item_id=7',845,847),
(8,0,0,0,1774422000,1774785670,7,0,'Шаблон регламента подразделения',754,758,'1.0','3',1798700400,'https://docflow.hospital.local/docs','регламент,подразделение,нормативный документ','<p>Шаблон внутреннего регламента подразделения. Подходит для быстрого теста ввода данных, редактирования и хранения нормативной служебной документации.</p>','','https://docflow.hospital.local/index.php?module=dashboard/ecosystem&service=docspace&entity_id=26&item_id=8','https://docflow.hospital.local/index.php?module=dashboard/ecosystem&service=workspace&entity_id=26&item_id=8',843,847),
...
(383,0,183,1,'Нормативный документ','',1,'#bde0fe',1,'','',''),
...
(411,0,238,1,'Нормативные документы','',0,'',2,'','',''),
...
(817,0,243,1,'Нормативный документ','',0,'#f8edeb',4,'','',''),
...
(821,0,294,1,'Регламенты и документы подразделения','',0,'#f8edeb',4,'','',''),
(822,0,294,1,'Служебная записка / приказ / локальный акт','',0,'#ffd6a5',5,'','',''),
...
(3,25,282,'','department-memo-ivan-ivanov.docx',0,'25/2026/03/29/3','docflow.hospital.local-3-1774785667','',1774706097,1),
(4,25,282,'','department-regulation-ivan-ivanov.docx',0,'25/2026/03/29/4','docflow.hospital.local-4-1774785667','',1774706097,1),
